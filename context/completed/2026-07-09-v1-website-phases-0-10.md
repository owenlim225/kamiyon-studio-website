# v1 website — Phases 0–10

**Archived:** 2026-07-10 (roadmap complete)  
**Status:** Prior v1 website roadmap (Phase 0–10) is **complete**. CMS later migrated to Payload (see [6-07-11-payload-migration-phases-0-6.md](./2026-07-11-payload-migration-phases-0-6.md)).  
